...
public class Simulator {
    public static void main(String[] args) {
        ...
        cursoService.agregar(c1);
        cursoService.agregar(c2);
        System.out.println("Cursos creados.");

        // 2) Crear profesores
        Profesor p1 = new Profesor("Ana", "Gómez", "P001");
        Profesor p2 = new Profesor("Luis", "Ramírez", "P002");
    profesorCrud.agregar(p1);
    profesorCrud.agregar(p2);
        System.out.println("Profesores creados.");

        // 3) Crear estudiantes y matricularlos
        Estudiante e1 = new Estudiante("Carlos", "Pérez", "E001");
        Estudiante e2 = new Estudiante("María", "Santos", "E002");
        Estudiante e3 = new Estudiante("Jorge", "Molina", "E003");
        admin.agregarEstudiante(e1);
        admin.agregarEstudiante(e2);
        admin.agregarEstudiante(e3);
        ...
        grupoService.agregar(g1);
        // crear matrículas
        matriculaService.agregar(new Matricula(e1, g1));
        matriculaService.agregar(new Matricula(e2, g1));
    ...
    eval.agregarPregunta(q5);
        ...
        profesorService.agregarEvaluacion(eval);
    ...
    ResultadoEvaluacion r1 = new ResultadoEvaluacion(e1.getNombre() + " " + e1.getApellido1(), eval, obtenido1, total);
    ...
    double obtenido2 = q1.getValor() + 0 + q3.getValor() + 0 + (q5.getValor() * 2.0 / 3.0);
        ResultadoEvaluacion r2 = new ResultadoEvaluacion(e2.getNombre() + " " + e2.getApellido1(), eval, obtenido2, total);
